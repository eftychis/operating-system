...
// ***********************************************************************
//
#define STARTUP_MSG	"CS345 F2011"
...
#define mySIGDBUG			0x0020	// i added this to pause all but the shell
...
//	void (*sigKillHandler)(void);	// task mySIGKILL handler
	...
	void (*sigDbugHandler)(void);	// task mySIGDBUG handler
...
int P3_dcPrint(int, char**);
int P3_dcTest(int, char**);
